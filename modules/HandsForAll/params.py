...
MODEL_3D_3RD_PATH = 'modules/HandsForAll/models_saved/mano3dhands_3rd_person_resnet_pose_3d_pretrained.pth.tar'
MODEL_3D_EGO_PATH = 'models_saved/mano3dhands_egocentric_resnet_pose_3d_pretrained.pth.tar'

UI_HEIGHT = 1000
IMG_SIZE = 640  # 640, 480
IMG_WIDTH = 640
IMG_HEIGHT = 480
...
pytorch3d_img_w = IMG_WIDTH
pytorch3d_img_h = IMG_HEIGHT
