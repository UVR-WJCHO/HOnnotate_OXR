...
import modules.HandsForAll.utils as utils
...
class Model(nn.Module):
    def __init__(self, mano_path, renderer, renderer2, device, batch_size, root_idx = 0):
        ...
        self.key_bone_len = params.mano_key_bone_len
        ...
        self.img_center_width = params.IMG_WIDTH / 2.0    # 320
        self.img_center_height = params.IMG_HEIGHT / 2.0  # 240
        self.batch_size = batch_size

        self.K = torch.tensor([[357, 0, self.img_center_width],[0, 357, self.img_center_height],[0,0,1]], \
    ...
    def forward(self):      # kpts_3d_glob_leap : predicted 3D kpts
