...
OXR_MULTI_CAMERA_DIR = os.path.join(os.path.dirname(os.path.realpath(__file__)),  '../../dataset/')

YCB_MODELS_DIR = os.path.join(os.path.dirname(os.path.realpath(__file__)), '../YCBobject/models/')
