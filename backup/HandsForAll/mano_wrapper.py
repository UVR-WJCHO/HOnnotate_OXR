...
import torch
from modules.HandsForAll.models import mano_layer_annotate
import modules.HandsForAll.params
...
from modules.HandsForAll.models import mano_layer_render
...
class mano_fitter:
    ...
    def set_input_size(self, img_input_width, img_input_height):
        self.img_input_width = img_input_width
        self.img_input_height = img_input_height
    ...
    def fit_xyz_root_init(self, kpts_2d_glob, is_tracking):
        ...
        kpts_2d_glob = kpts_2d_glob*np.array([float(params.pytorch3d_img_w)/self.img_input_height, \
            float(params.pytorch3d_img_w)/self.img_input_width])
    ...
    def fit_can_pose(self, kpts_3d_can, kpts_2d_glob, is_tracking):
        # Scale kpts 2d glob to match pytorch 3d resolution
        assert self.img_input_height is not None
        kpts_2d_glob = kpts_2d_glob*np.array([float(params.pytorch3d_img_h)/self.img_input_height, \
            float(params.pytorch3d_img_w)/self.img_input_width])
