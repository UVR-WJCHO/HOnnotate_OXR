...
class loadDataset():
    ...
    def getItem(self, idx, save_idx):
        ...
        if self.info != None:
            ...
            for cam in camIDset:
                self.info['images']['file_name'].append(os.path.join("rgb", str(cam) + '/' + str(cam) + '_' + str(save_idx) + '.jpg'))
                self.info['images']['file_name'].append(os.path.join("depth", str(cam) + '/' + str(cam) + '_' + str(save_idx) + '.png'))
            self.info['images']['id'] = str(self.db+'_result') + str(self.subject_id) + str(self.obj_id) + str(self.grasp_id) + str(self.trial_num) + str(save_idx)
            ...
            with open(os.path.join(self.annotDir, "annot_%04d.json"%save_idx), "w") as w:
